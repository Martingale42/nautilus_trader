...
them. See `nautilus_trader/adapters/sinopac/__init__.py` for the full capability
...
- Unit and integration suites are green:
  - Rust: `cargo test -p nautilus-sinopac`
  - Python: `uv run pytest tests/integration_tests/adapters/sinopac`
